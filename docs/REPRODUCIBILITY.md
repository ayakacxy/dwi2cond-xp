...
data under their original terms, perform the excluded preprocessing, and create
a SimNIBS 4.6 CHARM head model. Do not upload identifiable or controlled-access
